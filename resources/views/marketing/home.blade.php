            ...
            <div class="ticker-track flex w-max gap-10">
                @for ($pass = 0; $pass < 2; $pass++)
                    @foreach ([
                        ...
                        ['M4 4h16v6H4zM4 14h16v6H4z', 'ستة ثيمات جاهزة'],
...
<section class="border-y border-border bg-card py-20 md:py-28">
    <div class="mx-auto max-w-6xl px-6">
        ...
        <div class="mt-14 grid gap-4 md:grid-cols-3">
            ...
            @foreach ([
                ['M3 9 12 2l9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z', 'دومينك الخاص', 'اكتب دومينك وإحنا نقولك تعمل إيه بالظبط. الشهادة الأمنية بتتظبط لوحدها.'],
                ['M12 20V10M18 20V4M6 20v-4', 'بيكسل و CAPI', 'فيسبوك وتيك توك وسناب، والشراء بيتبعت من السيرفر كمان.'],
                ['M4 4h16v6H4zM4 14h16v6H4z', 'ستة ثيمات', 'كل ثيم ليه معرض حي بمنتجات، تتفرج عليه قبل ما تفعّله.'],
            ] as [$icon, $title, $body])
